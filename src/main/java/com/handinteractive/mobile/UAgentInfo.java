...
public class UAgentInfo
{
  ...
  public static final String deviceWebOS = "webos"; // For Palm's line of WebOS
                                                    // devices
  public static final String deviceWebOShp = "hpwos"; // For HP's line of WebOS
                                                      // devices
  ...
  public static final String deviceTablet = "tablet"; // Generic term for slate
                                                      // and tablet devices
  ...
  public static final String engineNetfront = "netfront"; // Common embedded OS
                                                          // browser
  ...
  public static final String engineTelecaQ = "teleca q"; // a modern feature
                                                         // phone browser
  public static final String engineObigo = "obigo"; // W 10 is a modern feature
                                                    // phone browser
  ...
  public boolean detectMaemoTablet()
  {
    if (userAgent.indexOf(maemo) != -1)
    {
      ...
      if (userAgent.indexOf(linux) != -1 && userAgent.indexOf(deviceTablet) != -1 && !detectWebOSTablet() && !detectAndroid())
      {
        return true;
      }
    return false;
  ...
  public boolean detectMobileQuick()
  {
    ...
    if ((userAgent.indexOf(engineObigo) != -1) || (userAgent.indexOf(engineNetfront) != -1) || (userAgent.indexOf(engineUpBrowser) != -1) || (userAgent.indexOf(engineOpenWeb) != -1))
      return true;
  ...
  public boolean detectTierIphone()
  {
    ...
    if (detectIphoneOrIpod() || detectAndroidPhone() || detectWindowsPhone() || detectBlackBerry10Phone() || (detectBlackBerryWebKit() && detectBlackBerryTouch()) || detectPalmWebOS() || detectBada()
